...
function renderVar(arg) {
  const typeofArg = arg === null ? 'null' : Array.isArray(arg) ? 'array' : typeof arg; // Return early for NULL, empty arrays, empty strings and FALSE booleans.
  ...
  arg['#printed'] = false; // Cast the Object to a string using its toString method.

  return `${arg}`; // TODO: Add config for a render function.
  // const string = `${arg}`;
  //
