...
function createAttribute(attributes = {}) {
  let attributeObject; // @TODO: https://github.com/JohnAlbin/drupal-twig-extensions/issues/1

  if (attributes instanceof Map || Array.isArray(attributes)) {
    attributeObject = new _Attribute.default(attributes);
  } else {
    attributeObject = new _Attribute.default(); // Loop through all the given attributes, if any.
