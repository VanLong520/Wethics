...
async function callable(element, argsMap) {
  ...
  return (0, _definition.without)(element, ...args);
}

var _default = (0, _twing.newTwingFilter)(_definition.name, callable, _definition.options);
