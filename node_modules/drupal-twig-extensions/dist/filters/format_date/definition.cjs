...
function formatDate(config, timestamp, type = 'medium', format = '', // eslint-disable-next-line no-unused-vars
timezone = null, // eslint-disable-next-line no-unused-vars
langcode = null) {
...
function configInit(state, config) {
  ...
  if (Object.prototype.hasOwnProperty.call(config, 'date_format')) {
    ...
    state.dateFormats = { ...state.dateFormats,
      ...config.date_format
    };
  }
}